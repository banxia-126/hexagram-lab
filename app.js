...
function renderSettings() {
  ...
  b.innerHTML = `
    ...
    <div class="srow">
      ...
      <div class="srow-d">历史时区、地方性做法或别派算法用这里兜底。</div>
    </div>
    ...
    <div class="srow">
      ...
      <div class="srow-d">三钱法掷铜钱，大衍筮法取蓍草十八变的结果概率（老阳偏多）。摇卦按这里选的法子，一爻一爻摇，共六次。</div>
    </div>
...
const TOPICS = {
  ...
  liuyao: {
    t: '六爻 · 原理与出处', h: `
      ...
      <h4>两种筮法</h4>
      <p>三钱法三枚铜钱掷一次；大衍筮法取蓍草「十八变」的结果概率，<b>老阳明显偏多</b>。
      两者都落在 6 / 7 / 8 / 9 上，往下装卦的走法一样，在<b>设置</b>里切换。</p>
      <h4>装卦不用查表</h4>
  ...
  meihua: {
    t: '梅花易数 · 原理与出处', h: `
      ...
      体、用各查一遍〈八卦萬物屬類〉，把卦还原成具体的东西。</p>` + SRCNET,
  },
  settings: {
    t: '设置 · 原理与出处', h: `
      <h4>为什么要给开关</h4>
